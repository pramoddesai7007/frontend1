    ...
    const handleEdit = async () => {
        try {
            ...
            const response = await axios.patch(
                `https://backend1-ashen.vercel.app//api/menu/menus/${menuToEdit._id}`,
                formData
            );
...
const MenuList = () => {
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `https://backend1-ashen.vercel.app//api/menu/menus/${menuToDelete._id}`
            );
    ...
    const addNewMenu = async () => {
        try {
            ...
            const response = await axios.post(
                `https://backend1-ashen.vercel.app//api/menu/menu`,
                formData
            );
        ...
        const fetchMenus = async () => {
            try {
                const response = await axios.get(
                    "https://backend1-ashen.vercel.app//api/menu/menus/list"
                );
    ...
    const handleFileUpload = async () => {
        try {
            ...
            const response = await axios.post(
                "https://backend1-ashen.vercel.app//api/menu/upload-excel",
                formData
            );
    ...
    const modalContent = (
        ...
        >
            <button
                ...
                className="absolute top-4 right-4 bg-orange-100 text-red-600 hover:bg-red-200 p-2 py-1 rounded-full text-center"
            >
                <FontAwesomeIcon icon={faTimes} size="lg" />
            </button>
                    ...
                    <div className="modal-container bg-white w-96 p-8 rounded-md shadow-lg m-1">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-4">
                                ...
                                {menuToView?.imageUrl ? (
                                    <img
                                        src={`https://backend1-ashen.vercel.app//${menuToView.imageUrl}`}
                                        alt="Menu"
