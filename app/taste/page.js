...
//   ********
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://backend1-ashen.vercel.app//api/taste/tastes/${selectedTaste._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      ...
      await axios.delete(`https://backend1-ashen.vercel.app//api/taste/tastes/${selectedTaste._id}`);
...
// ***********
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://backend1-ashen.vercel.app//api/taste/tastes', { taste: newTaste });
