...
const PurchaseReport = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const purchasesResponse = await axios.get("https://backend1-ashen.vercel.app//api/purchase/purchases");
        setPurchases(purchasesResponse.data);
        setFilteredPurchases(purchasesResponse.data);

        const itemsResponse = await axios.get("https://backend1-ashen.vercel.app//api/item/items");
        setItems(itemsResponse.data);

        const vendorsResponse = await axios.get("https://backend1-ashen.vercel.app//api/supplier/suppliers");
