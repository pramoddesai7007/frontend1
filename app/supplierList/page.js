...
const SupplierList = () => {
    ...
    useEffect(() => {
        const fetchSuppliers = async () => {
            try {
                const response = await axios.get('https://backend1-ashen.vercel.app//api/supplier/suppliers');
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            const response = await axios.patch(
                `https://backend1-ashen.vercel.app//api/supplier/suppliers/${editedSupplier._id}`,
                editedSupplier
            );
    ...
    const handleDeleteConfirmed = async () => {
        try {
            ...
            await axios.delete(`https://backend1-ashen.vercel.app//api/supplier/suppliers/${editedSupplier._id}`);
